          ...
          <Stack gap="xl">
            ...
            <Stack gap="lg">
              ...
              <section>
                ...
                <Text size="sm" style={{ lineHeight: 1.8 }}>
                  1.
                  ユーザーは、GitHub、Google等の外部サービスを用いた認証によりアカウントを作成します。
                  <br />
                  2.
                  ユーザーは、自己の責任においてアカウントを管理するものとし、第三者への譲渡・貸与は禁止します。
                </Text>
              </section>
              ...
              <section>
                ...
                <Text size="sm" style={{ lineHeight: 1.8 }}>
                  1.
                  ユーザーが投稿したプロジェクト情報は、本サービス上で他のユーザーに公開されます。
                  <br />
                  2.
                  ユーザーがアカウントを削除した場合、そのユーザーが所有するプロジェクト、プロフィール、および画像データは
              ...
              <section>
                ...
                <Text size="sm" style={{ lineHeight: 1.8 }}>
                  1.
                  本サービスは現状有姿で提供されます。運営者は、本サービスの継続性・正確性・完全性について保証しません。
                  <br />
                  2.
                  サービスの障害・停止・データ損失等によってユーザーに生じた損害について、運営者は一切の責任を負いません。
                </Text>
              </section>
