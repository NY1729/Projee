            ...
            <Stack gap="lg">
              <Box>
                ...
                <Text size="sm" style={{ lineHeight: 1.7 }}>
                  当サービスは、外部認証プロバイダ（GitHub / Google /
                  Discord）から提供される以下の情報を収集します。
                  <br />
                  ・氏名またはユーザー名、メールアドレス、プロフィール画像URL。
                </Text>
              </Box>
              ...
              <Box>
                ...
                <Text size="sm" style={{ lineHeight: 1.7 }}>
                  データは Supabase (PostgreSQL)
                  上で管理され、適切なセキュリティ対策を講じています。ユーザー自身がアカウント削除を実行した場合、すべての関連データは直ちに物理削除されます。
                </Text>
              </Box>
            </Stack>
